        ...
        <form id="pembayaranForm" action="{{route('submitPembayaran')}}" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" class="form-control @error('kodeInternal') is-invalid @enderror" name="kodeInternal" value="{{ $kodeInternal }}">
                    @error('kodeInternal')
                    <span class="form-text text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <input type="text" name="idPenjualan" class="form-control @error('idPenjualan') is-invalid @enderror" value="{{ $idPenjualan }}" readonly>
                ...
                <div class="col-lg-6">
                    ...
                    <select name="jenisBayar" class="form-control @error('jenisBayar') is-invalid @enderror" id="jenisBayar">
                        ...
                        <option value="cash" @if($jenisBayar == 'cash') selected @endif>Cash</option>
                        <option value="transfer" @if($jenisBayar == 'transfer') selected @endif>Transfer</option>
                    </select>
                    @error('jenisBayar')
                    <span class="form-text text-danger">{{ $message }}</span>
                    @enderror
            ...
            <div class="form-group row">
                <div class="col-lg-6">
                    <label>Tanggal</label>
                    <input type="text" id="tanggal" name="tanggal" class="form-control @error('tanggal') is-invalid @enderror" value="{{$tanggal}}">
                    @error('tanggal')
                    <span class="form-text text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control @error('nominal') is-invalid @enderror" name="nominal" value="{{$nominal}}">
                    </div>
                    @error('nominal')
                    <span class="form-text text-danger">{{ $message }}</span>
                    @enderror
