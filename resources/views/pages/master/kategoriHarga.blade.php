<x-metronics-layout>
    ...
    <x-slot name="subHeader">
        <x-sub-header title="Master" subTitle="Data Kategori Harga"></x-sub-header>
    </x-slot>
    ...
    <x-metronics-card>
        ...
        <x-slot name="title">
            ...
            <h3 class="card-label">Data Kategori Harga</h3>
        </x-slot>
    ...
    <x-modals modalId="modalCrud" formId="formModal">
        ...
        <div class="form-group row">
            ...
            <div class="col-9">
                <input class="form-control" name="namaKategori" type="text" id="example-text-input">
            </div>
        </div>
        <div class="form-group row">
    ...
    <x-slot name="scripts">
        ...
        <script src="/pages/kategoriHarga.js"></script>
        <!--end::Page Scripts-->
    </x-slot>
