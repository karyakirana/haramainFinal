        ...
        <div class="row">
            <div class="col-md-8">
                <form action="#" id="master">
                    ...
                    <input type="text" name="id_customer" value="{{$idCustomer}}" hidden>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" id="tanggalNota" name="tanggalNota" value="{{$tgl_nota}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <input type="text" class="form-control" id="customerInput" name="customer" value="{{$namaCustomer}}">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" id="tanggalTempo" name="tanggalTempo" value="{{$tgl_tempo}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <select name="statusBayar" id="statusBayar" class="form-control">
                                <option value="Tunai" {{($status_bayar == "Tunai") ? "selected" : ""}}>Tunai</option>
                                <option value="Tempo" {{($status_bayar == "Tempo") ? "selected" : ""}}>Tempo</option>
                            </select>
                        </div>
                    </div>
                </form>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="biayaLain" value="{{$biaya_lain}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
