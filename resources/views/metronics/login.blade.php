...
<head>
    <meta charset="utf-8" />
    <title>Haramain APP | Login</title>
        ...
        <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
            ...
            <div class="d-flex flex-column-fluid flex-center">
                ...
                <div class="login-form login-signin">
                    <!-- alert -->
                    <div class="alert alert-custom alert-outline-2x alert-outline-danger fade mb-5" role="alert" id="alertLogin">
                        <div class="alert-icon"><i class="flaticon-warning"></i></div>
                        <div class="alert-text">
                            <ul id="keteranganSignin">
                            </ul>
                        </div>
                ...
                <div class="login-form login-signup">
                    <!-- alert -->
                    <div class="alert alert-custom alert-outline-2x alert-outline-danger fade mb-5" role="alert" id="alertRegister">
                        <div class="alert-icon"><i class="flaticon-warning"></i></div>
                        <div class="alert-text">
                            <ul id="keteranganSignup">
                            </ul>
                        </div>
                        <div class="alert-close">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
